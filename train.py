...
iter_batches = partial(
    ...
    device=device,
    num_workers=0,
    data_dir = tinystories.data_dir_name if not FINETUNE else tinystories.finetuning_data_dir_name    
)
...
if FINETUNE:
    ...
    model.load_state_dict(model_weights.get("model"))
    model = lora.apply_lora_to_model(model=model)
